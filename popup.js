...
const addNewBookmark = (bookmarks, bookmark) => {
    ...
    newBookmarkElement.id = "bookmark-" + bookmark.url.toString().split("-").at(-1);//splits the url into an array  and accesses the last element of the array which on then concatenated with bookmark-
